...
MDE and QANON folders for the various datasets. The final character is a key for which dataset the representations were generated from:

_M is from Maestro, _C is from Chopin43, and _CH is ChopinAndHannds

The contents of the folder is laid out at the top of the 01_Process_Data_For_LM_Task notebook
...
Current status:
I am very confident in the extracting MDE representations and pretraining LM portions of the project. However, at the point of this handoff, there are no checks in place to validate the performance of the finetuned model on NSP and compatibility. 
